...
def range_check(sorted_line1, sorted_line2):
    if sorted_line1[0][0] > sorted_line2[1][0] or sorted_line1[1][0] < sorted_line2[0][0]:
        return True
    else:
        return False
...
if __name__ == "__main__":
    ...
    line2 = [[x3, y3], [x4, y4]]
    line2.sort()
    rev_line1 = [[y1,x1],[y2,x2]]
    rev_line1.sort()
    rev_line2 = [[y3,x3],[y4,x4]]
    rev_line2.sort()

    if range_check(line1,line2) or range_check(rev_line1,rev_line2):
        print(0)
    else:
